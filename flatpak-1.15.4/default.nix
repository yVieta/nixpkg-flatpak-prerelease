...
stdenv.mkDerivation (finalAttrs: {
  ...
  #TODO
  #preConfigure = ''
  # Add the following line to copy the missing file to the expected location:
  #cp $SOURCE_DIR/subprojects/Makefile-libglnx.am.inc subprojects/
  # Run the autoreconf script to regenerate the configure script and related files:
  #autoreconf -vfi
  #'';
  ...
  meta = with lib; {
    ...
    maintainers = with maintainers; [ Tsubajashi ];
